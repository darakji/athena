...
#PBS -j oe
#PBS -o new_output_node2.log
#PBS -e new_error_node2.log
...
mapfile -t CIFS < /eagle/DFTCalculations/mehul/ml/athena/group_gpu2.txt
...
for i in 0 1 2 3; do
  ...
  CUDA_VISIBLE_DEVICES=$i python \
    ...
    > ${OUT_BASE}/logs/node2_gpu${i}_${PBS_JOBID}.out 2>&1 &
done
