...
OUT_BASE = "/home/mehuldarak/athena/li_llzo_unrelaxed_stacking_woVacancies_2500_3000"
LOG_FILE = os.path.join(OUT_BASE, "li_llzo_gap_scan_woVacancies_2500_3000.md")
...
with open(LOG_FILE, "w") as f:
    f.write("# Li–LLZO Interface Gap Scan (woVacancies Structures)\n\n")
    f.write(
...
for interface_dir in sorted(os.listdir(IN_BASE)):
    ...
    for f in os.listdir(path):
        ...
        elif f.endswith("__fixed.cif"): # __fixed has no vacancies while __vacancy has vacancies
